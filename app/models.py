...
class Quiz(db.Model):
    ...
    created_at = db.Column(db.DateTime(timezone=True),  default=db.func.now(), server_default=db.func.now(), nullable=False)
...
class QuizHistory(db.Model):
    ...
    date_taken = db.Column(db.DateTime(timezone=True), default=db.func.now(), server_default=db.func.now(),  nullable=False)
...
class Notification(db.Model):
    ...
    date_sent = db.Column(db.DateTime(timezone=True), default=db.func.now(), server_default=db.func.now(),  nullable=False)
